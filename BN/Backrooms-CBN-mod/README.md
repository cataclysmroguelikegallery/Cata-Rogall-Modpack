...
> [!CAUTION]
> Disclaimer: [original mod](https://github.com/TGWeaver/Backrooms-CDDA-Mod) is by @TGWeaver. All credits goes to the respective authors. I'm just maintaining it.

A mod updated to work for [modern BN](https://github.com/cataclysmbn/Cataclysm-BN/). 
